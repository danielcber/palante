<input type="hidden" name="evento" value="registrar">
	...
	<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
		...
		<hr>
			...
			<form class="form form-responsive" method="POST" action="modelos/evento/registrar.php" id="registrarevento" enctype="multipart/form-data">
			  ...
			  <?php
			    ...
			    <div class="form-group">
			    	...
			    	<select  id="categoria" name='categoria' class="form-control" required="required" style='height: 30px;'>
			    		<option style='height: 20px;'>Seleccione una categoría</option>
			    		<?php 
			  ...
			  <div class="form-group">
			    ...
			    <select class="form-control" id="organizacion" name="organizacion" style="height: 30px;">
			    	<option style='height: 20px;'>Seleccione una organización</option>
			    	<?php 
					while ($row = mysql_fetch_array($result2))
					{
					    echo "<option style='height: 20px;' value=".$row['id'].">".$row['org']."</option>";
					}
					?>    
			    </select>
			  </div>
			  ...
			  <div class="row">
				  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				    ...
				    <div class="panel">
				    Fecha <input type="date" placeholder="dd/mm/aaaa" id="startdate" name="startdate"><br><br>
				  ...
				  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				    ...
				    <div class="panel">
				    Fecha <input type="date" placeholder="dd/mm/aaaa" id="enddate" name="enddate"><br><br>
			  ...
			  <div class="form-group">
			    <label for="descripcion">IMAGEN DE EVENTO</label>
